...
>
> Para esse código, o uso manual de thread com ExecutorService não é tão interessante, somente seria se, para cada linha tivesse que chamar uma API ou acessar banco de dados;
